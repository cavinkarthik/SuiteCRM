...
class pdfGenerator
{
    ...
    public function __construct()
    {
        ...
        $this->search =array('/<script[^>]*?>.*?<\/script>/si',      // Strip out javascript
    ...
    public function generatePDF($templateId)
    {
        ...
        $header = preg_replace($this->search, $this->replace, $template->pdfheader);
        $footer = preg_replace($this->search, $this->replace, $template->pdffooter);
        $text = preg_replace($this->search, $this->replace, $template->description);
        ...
        $groupPartTemp = $this->populate_group_lines($groupPart);
        $groupPartTemp = $this->populate_product_lines($groupPart, $lineItemsArray);
